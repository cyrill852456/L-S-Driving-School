...
import { savedScore, updateSessionOne } from '@/lib/services/TDCOnlineTraining/onlineTrainingSevice';
...
const QuizSection = () => {
  ...
  const SESSION_NAME = 'session_one';
  ...
  const handleProceedToSession2 = async () => {
    try{
      await updateSessionOne();
