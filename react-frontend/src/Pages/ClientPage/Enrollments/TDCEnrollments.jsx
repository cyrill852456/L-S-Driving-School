...
import { ArrowRight, ArrowLeft,  CheckCircle2, Upload, AlertCircle, Loader2, FormInput } from 'lucide-react';
import { Alert, AlertDescription, AlertTitle } from "@/components/ui/alert";
import PaymentQRCode from '@/assets/qrcode.png'
import { submitEnrollment } from '@/lib/services/EnrollmentServices/enrollmentServices';
import { PDFDownloadLink, Document, Page, Text, View, StyleSheet, Image } from '@react-pdf/renderer';
import { TDCCourse } from '@/lib/services/Courses';
import { Validator } from '@/lib/services/EnrollmentServices/enrollmentServices';
        ...
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            ...
            <View>
              ...
              <Text style={styles.value}>Online Exam & Lecture</Text>
            </View>
          </View>
...
export default function EnrollmentProcess() {
    ...
    const nextStep = () => step < 3 && !showAgeAlert ? setStep(step + 1) : null;
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-8">
              <div className="flex justify-between items-center">
                {['Enrollment Form', 'Payment', 'Confirmation'].map((label, index) => (
    ...
    const handleSubmit = async (e) => {
      ...
      return (
        ...
        <CardHeader className="space-y-4 text-center border-b pb-6">
          ...
          <h1 className="text-3xl font-semibold text-gray-900">Online Lecture Enrollment Form</h1>
        </CardHeader>
            ...
            <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input className="w-full" type='file'  name='document_path' multiple accept='.pdf,.doc,.docx,.png,.jpg' placeholder="Enter email address" required />
                    </div>
                  </div>
                </div>
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            {/* if the user is under 18 show this error */}
            {showAgeAlert && (
...
function ConfirmationPage() {
    ...
    const handleSubmit = async () => {
      try {
        ...
        await submitEnrollment(enrollmentData, paymentDetails);
